...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: 'https', hostname: '**.igrandtheftauto.com' },
      ...
      { protocol: 'https', hostname: 'www.creativeuncut.com' },
      { protocol: 'https', hostname: 'reanimal.thqnordic.com' },
      { protocol: 'https', hostname: '**.kojimaproductions.jp' },
      { protocol: 'https', hostname: 'www.gamemaps.com' },
    ],
  },
};
