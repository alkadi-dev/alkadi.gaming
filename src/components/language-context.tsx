...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'how.step5.desc': 'Get your games delivered directly to your home and ready to play in record time.',
    ...
    'upgrade.title': 'Special Upgrade Offer',
    'upgrade.message': 'Get 40% OFF by upgrading to the 1TB hard drive instead of choosing the 500GB option.',
    'upgrade.btnUpgrade': 'Upgrade to 1TB',
    'upgrade.btnContinue': 'Continue with 500GB',
    'upgrade.btnUpgrade2tb': 'Upgrade to 2TB',
    'upgrade.btnContinue1tb': 'Continue with 1TB',
    'pricing.title': 'Pricing Plans',
    'pricing.subtitle': 'Choose the capacity that fits your gaming needs',
    'pricing.recommended': 'Recommended',
    'pricing.bigValue': 'Big Value',
    'pricing.games': 'Games',
    'pricing.withEnclosure': 'with Enclosure',
    'pricing.freeDelivery': 'Free Delivery',
    'pricing.basic': 'Basic',
  ...
  ar: {
    ...
    'how.step5.desc': 'احصل على ألعابك واصلة مباشرة إلى منزلك وجاهزة للعب في وقت قياسي.',
    ...
    'upgrade.title': 'عرض ترقية خاص',
    'upgrade.message': 'احصل على خصم 40% عند الترقية إلى قرص صلب سعة 1 تيرابايت بدلاً من اختيار 500 جيجابايت.',
    'upgrade.btnUpgrade': 'ترقية إلى 1 تيرابايت',
    'upgrade.btnContinue': 'الاستمرار بـ 500 جيجابايت',
    'upgrade.btnUpgrade2tb': 'ترقية إلى 2 تيرابايت',
    'upgrade.btnContinue1tb': 'الاستمرار بـ 1 تيرابايت',
    'pricing.title': 'خطط الأسعار',
    'pricing.subtitle': 'اختر السعة التي تناسب احتياجاتك في الألعاب',
    'pricing.recommended': 'موصى به',
    'pricing.bigValue': 'قيمة كبيرة',
    'pricing.games': 'ألعاب',
    'pricing.withEnclosure': 'مع غلاف خارجي',
    'pricing.freeDelivery': 'توصيل مجاني',
    'pricing.basic': 'أساسي',
