...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'how.step4.title': 'Delivered in Under 2 Days',
    'how.step4.desc': 'Get your games delivered directly to your hard drive and ready to play in record time.',
  ...
  ar: {
    ...
    'how.step4.title': 'توصيل في أقل من يومين',
    'how.step4.desc': 'احصل على ألعابك واصلة مباشرة إلى قرصك الصلب وجاهزة للعب في وقت قياسي.',
